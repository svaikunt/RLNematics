...
"offY" => 1e-2, # interpreted as a range around 0 if > 0
"q" => 0.4, # overall rotation of nematic field in initial configuration
"randParam" => 1e-2,
...
#"bounds" => [pi, -12], # range of allowed increments of the activityCoefficients
"bounds" => [pi], # range of allowed increments of the activityCoefficients
"taskMarker" => "orPlus",
"rewP" => 1e3, # strength of the penalty used to compute the reward
"rewT" => 5,
