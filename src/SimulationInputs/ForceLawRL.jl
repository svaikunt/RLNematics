...
"q" => 0.25, # overall rotation of nematic field in initial configuration
"randParam" => 0.2,
...
"taskMarker" => "follower",
"rewP" => 1.0, # strength of the penalty used to compute the reward
"rewT" => 1.0,
...
"episodeStride" => 1,
"stateTrajStride" => 50,
"batchSize" => 32, # how many samples to include in replay buffer used to train the networks
