...
"q" => 0*pi/2 + 1e-4, # overall rotation of nematic field in initial configuration
"randParam" => 0.25,
...
"ks" => 0.002, # stiffness times the drag
...
"bounds" => [5], #[offset, c0Range] range of allowed increments of the activityCoefficients
"taskMarker" => "sepPlus",
...
"seed" => 4, # random seed for network initialization
